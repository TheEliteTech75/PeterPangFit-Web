...
<div class="cookie-consent" role="dialog" aria-live="polite" aria-label="Cookie consent">
    <p><strong>We use cookies to enhance your experience.</strong> Session cookies help keep you logged in securely and remember your preferences while you explore Peter Pang Fit.</p>
...
<script>
(function () {
    var storageKey = 'ppf-cookie-consent';
    var banner = document.querySelector('.cookie-consent');
    if (!banner) {
        return;
    }
    var dismissButton = banner.querySelector('[data-consent-dismiss]');
    if (!dismissButton) {
        return;
    }
    try {
