    ...
    function ppf_theme_catalog(): array {
        ...
        $themes = [
            'default' => [
                'name' => 'Default',
                'category' => 'Default',
                'description' => 'Our signature navy and teal palette.',
                'preview' => ['#0b1320', '#1d4ed8', '#0f766e'],
                'variables' => [
                    '--bg' => '#0b1320',
                    '--bg-alt' => '#091222',
                    '--surface' => 'rgba(15, 23, 42, 0.92)',
                    '--surface-alt' => 'rgba(22, 33, 62, 0.82)',
                    '--surface-soft' => 'rgba(30, 41, 70, 0.6)',
                    '--surface-strong' => 'rgba(11, 18, 35, 0.95)',
                    '--panel' => 'rgba(12, 24, 46, 0.92)',
                    ...
                    '--muted-soft' => 'rgba(100, 116, 139, 0.68)',
                    '--danger' => '#dc2626',
                    '--warning' => '#d97706',
                    '--success' => '#16a34a',
            ...
            'usa' => [
                ...
                'variables' => [
                    ...
                    '--border-strong' => 'rgba(185, 28, 28, 0.32)',
                    '--primary' => '#b91c1c',
            ...
            'christmas' => [
                ...
                'variables' => [
                    ...
                    '--border' => 'rgba(34, 197, 94, 0.24)',
                    '--border-strong' => 'rgba(185, 28, 28, 0.34)',
                    '--primary' => '#b91c1c',
                    '--primary-strong' => '#991b1b',
                    '--accent' => '#15803d',
